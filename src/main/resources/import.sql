...
insert into ticket(uuid, price, start, destination, status, passenger_uuid) values ('77243dc3-d162-4aa4-bcb0-6eb741173a01',100.25,'Piliyandala','Colombo',true,'$2a$10$5SM3OIksgYLL6LU8bb7Raeff2A1nwAuEsF.XoXQq6QxvJwRjh96Jq')
insert into ticket(uuid, price, start, destination, status, passenger_uuid) values ('77243dc3-d162-4aa4-bcb0-6eb741173a02',200.25,'Colombo','Nugegoda',true, '$2a$10$5SM3OIksgYLL6LU8bb7Raeff2A1nwAuEsF.XoXQq6QxvJwRjh96Jq')